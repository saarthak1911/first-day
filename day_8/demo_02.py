...
#Have context size limits
#Work better with smaller, meaningful chunks
#thats the reason we do text splitting / chunking
#Require chunking before storing text in vector databases


# CharacterTextSplitter is used for:
#Splits text strictly based on character count
#Once size reaches 200 characters → creates a chunk



#RecursiveCharacterTextSplitter is used for:
#Splits recursively
#Tries to preserve natural text boundaries like paragraphs and sentences and spaces betn words
